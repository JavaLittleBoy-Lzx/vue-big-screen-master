...
#### 1. 车辆进场统计
```
GET http://10.100.111.2:8675/parking/statistics/vehicle-entry
...
#### 2. 车辆出场统计
```
GET http://10.100.111.2:8675/parking/statistics/vehicle-exit
参数: startDate, endDate
返回: Integer（出场车辆数）
```
...
#### 3. 人脸进场统计
```
GET http://10.100.111.2:8675/parking/statistics/face-entry
参数: startDate, endDate
返回: Integer（进场人次）
```
...
#### 4. 人脸出场统计
```
GET http://10.100.111.2:8675/parking/statistics/face-exit
参数: startDate, endDate
返回: Integer（出场人次）
```
...
#### 人脸热力图
```
GET http://10.100.111.2:8675/parking/face-monitor/heatmap
